...
//   const handleWatchClick = (mediaItem: MediaItem) => {
//     saveScrollPosition(currentPage)
...
//       {currentPage === "movie-player" && selectedMediaItem && (
//         <MoviePlayerPage mediaItem={selectedMediaItem} onBack={handleBackToPrevious} />
//       )}
...
function App() {
  ...
  return (
    <div className="app">
      ...
      {currentPage === "movie-player" && selectedMediaItem && (
        <MoviePlayerPage mediaItem={selectedMediaItem} onBack={handleBackToPrevious} onMovieClick={handleMovieClick} />
      )}
